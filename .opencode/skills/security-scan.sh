#!/bin/bash
# taotao-cloud-ddd 安全扫描脚本
# 用于检查 DDD 项目中的常见安全问题

echo "================================================"
echo "  taotao-cloud-ddd 安全扫描"
echo "================================================"

# 扫描配置
BASE_DIR="."
MODULES=("taotao-cloud-ddd-api" "taotao-cloud-ddd-application" "taotao-cloud-ddd-domain" "taotao-cloud-ddd-infrastructure" "taotao-cloud-ddd-interfaces")
HAS_WARNINGS=0
