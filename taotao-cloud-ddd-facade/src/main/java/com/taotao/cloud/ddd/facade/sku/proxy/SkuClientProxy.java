...
package com.taotao.cloud.ddd.facade.sku.proxy;

import com.taotao.cloud.ddd.facade.sku.adapter.SkuClientAdapter;
import com.taotao.cloud.ddd.facade.sku.grpc.SkuGrpcClient;
import com.taotao.cloud.ddd.facade.sku.vo.SkuVO;
import com.taotao.cloud.goods.api.rpc.GoodsRpcService;
import com.taotao.cloud.goods.api.rpc.request.GoodsQueryRpcRequest;
